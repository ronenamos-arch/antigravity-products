## 🛠️ Primary Skill: building-product-pages
When working in this folder, **always use the `building-product-pages` skill first** for any task involving creating, building, or deploying a product page.
Skill location: `../.agents/skills/building-product-pages/SKILL.md`
Trigger: user provides a product URL (AliExpress/Amazon) + price → run the full skill workflow.

## 🎨 Design Skill: ui-ux-pro-max
For all UI/UX and visual design decisions, use the `ui-ux-pro-max` skill.
Skill location: `../.agents/skills/ui-ux-pro-max/SKILL.md`
Source: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill
Use for: color palettes, typography, layout patterns, landing page structure, mobile UX.
